...
import Contactos from "./pages/client/Contactos"; // <--- NUEVO IMPORT
...
import GestionContactos from "./pages/admin/GestionContactos"; // <--- NUEVO IMPORT
      ...
      <div className="App">
        ...
        <div className="main-content">
          <Routes>
            ...
            <Route path="/sobre-mi" element={<Curriculum />} />
            <Route path="/contactos" element={<Contactos />} /> {/* <--- NUEVA RUTA CLIENTE */}
            ...
            <Route path="/admin/contactos" element={<RutaProtegidaAdmin><GestionContactos /></RutaProtegidaAdmin>} /> {/* <--- NUEVA RUTA ADMIN */}
